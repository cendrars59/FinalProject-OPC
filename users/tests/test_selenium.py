...
class TestUserLogin:
    ...
    def test_login_page_sucess(self, live_server,driver_init, user1):
    ...
    def test_login_page_failed(self, live_server,driver_init, user1):
...
class TestUserLogout:
    ...
    def test_logout_page_sucess(self, live_server,driver_init, user1):
